...
- (void)viewDidLoad {
    ...
    clickOrNo = false;
    TableDataDelegate* tbDelegate = [[TableDataDelegate alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TableViewCellIn* cell = (TableViewCellIn*)[tableView dequeueReusableCellWithIdentifier:identifier];
    
    if (cell == nil)
    {
        cell = [[TableViewCellIn alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    {
        SeeViewController *destViewController = segue.destinationViewController;
